...
<div in:fly="{{x: 50, delay: 2000}}" out:fly="{{x: 200}}" class="-ml-24 md:ml-0 lg:px-12 px-16 lg:py-12 py-20" style="overflow: hidden;">
    <div class="browser-frame w-full rounded-md bg-gray-500 shadow-2xl" in:rotateHang="{{duration: 2000, delay: 1500}}" out:fly="{{x: -400}}">
